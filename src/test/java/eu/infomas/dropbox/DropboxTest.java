...
//    @Test
//    @Order(5)
//    public void testGetFileWithRange() throws IOException {
...
//    }
    ...
    //@Test
    @Order(99)
    public void testDelta() throws IOException, InterruptedException {
        // first call: use null as cursor
        DeltaPage page = dropbox.delta(null);
        Thread.sleep(10000);
        // now call next
        DeltaPage page1 = dropbox.delta(page.getCursor());
    ...
    public void testRevisions() throws IOException {
        List<Entry> entries = dropbox.revisions("/digipub/455.405.jpg", 10);
